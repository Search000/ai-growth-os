...
const ENGINE_PROMPTS: Record<string, string> = {
  ...
  lpo: `You are a Landing Page Optimization analyst. Based on the page content below, evaluate: headline strength, subheadline, offer clarity, benefits presentation, proof/trust elements, CTA effectiveness, objection handling, and overall page structure. Give 3-5 specific, actionable recommendations.`,
};

export async function runAnalysisEngine(engine: string, url: string): Promise<EngineReport> {
